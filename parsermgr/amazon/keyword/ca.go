...
type CAKeywordParser struct{}

func NewCAKeywordParser() *CAKeywordParser {
	return &CAKeywordParser{}
}

func (p *CAKeywordParser) ParseAllProducts(doc *html.Node) ([]*html.Node, error) {
...
func (p *CAKeywordParser) parseCurrentPageIndexV1(doc *html.Node) (string, error) {
...
func (p *CAKeywordParser) parseCurrentPageIndexV2(doc *html.Node) (string, error) {
...
func (p *CAKeywordParser) ParseCurrentPageIndex(doc *html.Node) (string, error) {
...
func (p *CAKeywordParser) parseNextPageURLV1(doc *html.Node) (string, error) {
...
func (p *CAKeywordParser) parseNextPageURLV2(doc *html.Node) (string, error) {
...
func (p *CAKeywordParser) ParseNextPageURL(doc *html.Node) (string, error) {
...
func (p *CAKeywordParser) ParseKeyword(doc *html.Node) (string, error) {
...
func (p *CAKeywordParser) ParseASIN(node *html.Node) (string, error) {
	expr := `@data-asin`
...
func (p *CAKeywordParser) ParsePrice(node *html.Node) (string, error) {
...
func (p *CAKeywordParser) ParseStar(node *html.Node) (string, error) {
...
func (p *CAKeywordParser) ParseRating(node *html.Node) (string, error) {
...
func (p *CAKeywordParser) ParseSponsered(node *html.Node) (string, error) {
...
func (p *CAKeywordParser) ParsePrime(node *html.Node) (string, error) {
...
func (p *CAKeywordParser) ParseSales(node *html.Node) (string, error) {
...
func (p *CAKeywordParser) ParseImg(node *html.Node) (string, error) {
...
func (p *CAKeywordParser) ParseTitle(node *html.Node) (string, error) {
